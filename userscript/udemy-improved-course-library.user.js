...
.improved-course-card--container::before {
  content: '';
  position: absolute;
  top: 0;
  bottom: 0;
...
.improved-course-card--container.impr__freshness--green::before {
  background: #1ea44b;
}

.improved-course-card--container.impr__freshness--yellow::before {
  background: #d9a000;
}

.improved-course-card--container.impr__freshness--red::before {
  background: #cb2f2f;
}
